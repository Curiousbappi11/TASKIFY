...
function Menu() {
  ...
  return (
    <>
      ...
      {/* menu container */}
      <div className={`px-4 ${isMenuToggle ? 'translate-x-0' : '-translate-x-full'} absolute transition-transform duration-300 flex flex-col items-center gap-4  w-56 h-full py-10`}>
        ...
        <div className='w-full flex flex-col gap-5'>
          ...
          {/* profile name */}
          <div>
            <p className='text-4xl font-extrabold'>Adams<br />Mitchell</p>
          </div>
        ...
        pt-4 pl-2 w-full flex flex-col gap-3 font-light'>
          ...
          <button className='flex gap-4' onClick={() => (navigate('/'), handleMenuClick())}>
          ...
          <button className='flex gap-4' onClick={() => (navigate('/tasks'), handleMenuClick())}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
          ...
          <button className='flex gap-4' onClick={() => (navigate('/notes'), handleMenuClick())}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
          ...
          <button className='flex gap-4' onClick={() => (navigate('/reminders'), handleMenuClick())}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
          ...
          <button className='flex gap-4' onClick={() => (navigate('/pomodoro'), handleMenuClick())}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
          ...
          <button className='flex gap-4' onClick={() => (navigate('/calendar'), handleMenuClick())}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
